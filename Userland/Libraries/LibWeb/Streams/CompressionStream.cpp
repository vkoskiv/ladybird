...
WebIDL::ExceptionOr<JS::NonnullGCPtr<CompressionStream>> CompressionStream::construct_impl(JS::Realm& realm, Bindings::CompressionFormat format)
{
    ...
    auto compression_stream = realm.heap().allocate<CompressionStream>(realm, realm);
    ...
    auto compress_algorithm = JS::create_heap_function(realm.heap(), [&realm, compression_stream](JS::Value chunk) -> JS::NonnullGCPtr<WebIDL::Promise> {
    ...
    auto flush_algorithm = JS::create_heap_function(realm.heap(), [&realm, compression_stream]() -> JS::NonnullGCPtr<WebIDL::Promise> {
